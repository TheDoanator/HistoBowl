...
function App() {
  ...
  return (
    ...
    <BrowserRouter>
      <div className='min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 transition-[background-color,text-decoration-color,color] duration-300 ease-out flex flex-col pb-12'>
        {/* Global Banner */}
